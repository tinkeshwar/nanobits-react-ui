...
export interface NNavGroupProps {
  children?: ReactNode
  /**
...
export const NNavGroup = forwardRef<HTMLLIElement, NNavGroupProps>(
    ({ children, className, compact, idx, toggler, visible, ...rest }, ref) => {
        const [height, setHeight] = useState<number | string>()
        const navItemsRef = useRef<HTMLUListElement>(null)

        const { visibleGroup, setVisibleGroup } = useContext(NNavContext)
...
NNavGroup.displayName = 'NNavGroup'
