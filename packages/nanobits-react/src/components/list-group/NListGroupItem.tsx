...
export interface NListGroupItemProps
...
export const NListGroupItem = forwardRef<
...
>(({ children, active, className, disabled, color, component = 'li', ...rest }, ref) => {
    ...
    const Component = component === 'a' || component === 'button' ? NLink : component
...
NListGroupItem.displayName = 'NListGroupItem'
