...
export interface NToasterProps extends HTMLAttributes<HTMLDivElement> {
  /**
  ...
  placement?:
    ...
    | string
  /**
   * Adds new `NToast` to `NToaster`.
   */
  push?: ReactElement
}

export const NToaster = forwardRef<HTMLDivElement, NToasterProps>(
