...
export interface NFormSwitchProps extends Omit<InputHTMLAttributes<HTMLInputElement>, 'size'> {
  /**
...
export const NFormSwitch = forwardRef<HTMLInputElement, NFormSwitchProps>(
...
NFormSwitch.displayName = 'NFormSwitch'
