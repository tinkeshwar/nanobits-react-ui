...
export interface NFormInputProps extends Omit<InputHTMLAttributes<HTMLInputElement>, 'size'> {
  /**
...
export const NFormInput = forwardRef<HTMLInputElement, NFormInputProps>(
...
NFormInput.displayName = 'NFormInput'
