...
export interface NSpinnerProps extends HTMLAttributes<HTMLDivElement | HTMLSpanElement> {
  /**
...
export const NSpinner = forwardRef<HTMLDivElement | HTMLSpanElement, NSpinnerProps>(
    (
        {
            className,
            color,
