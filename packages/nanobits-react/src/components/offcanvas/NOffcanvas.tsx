...
export interface NOffcanvasProps extends HTMLAttributes<HTMLDivElement> {
  /**
...
export const NOffcanvas = forwardRef<HTMLDivElement, NOffcanvasProps>(
    (
        {
            children,
            backdrop = true,
        ...
        return (
            <>
                ...
                {typeof window !== 'undefined' && portal ? backdrop && createPortal(
                    <NBackdrop className="offcanvas-backdrop" onClick={handleDismiss} visible={_visible} />, document.body) : backdrop && (
                    <NBackdrop
...
NOffcanvas.displayName = 'NOffcanvas'
