...
export interface NCarouselProps extends HTMLAttributes<HTMLDivElement> {
  /**
...
export const NCarouselContext = createContext({} as ContextProps)

export const NCarousel = forwardRef<HTMLDivElement, NCarouselProps>(
    (
        {
            children,
            activeIndex = 0,
