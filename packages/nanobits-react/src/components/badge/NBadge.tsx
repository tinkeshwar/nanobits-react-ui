...
export interface NBadgeProps extends HTMLAttributes<HTMLDivElement | HTMLSpanElement> {
  /**
...
export const NBadge = forwardRef<HTMLDivElement | HTMLSpanElement, NBadgeProps>(
    (
        {
            children,
            className,
