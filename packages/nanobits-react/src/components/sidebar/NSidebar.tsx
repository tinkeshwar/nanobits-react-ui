...
export interface NSidebarProps extends HTMLAttributes<HTMLDivElement> {
  /**
...
export const NSidebar = forwardRef<HTMLDivElement, NSidebarProps>(
    (
        {
            children,
            className,
        ...
        return (
            <>
                ...
                {typeof window !== 'undefined' &&  mobile && createPortal(<NBackdrop className="sidebar-backdrop" visible={_visible} />, document.body )}
            </>
        )
    },
)
