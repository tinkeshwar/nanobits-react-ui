...
export interface NDropdownProps extends HTMLAttributes<HTMLDivElement | HTMLLIElement> {
  /**
...
interface ContextProps extends NDropdownProps {
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  dropdownToggleRef: RefObject<any> | undefined
  setVisible: React.Dispatch<React.SetStateAction<boolean | undefined>>
}

export const NDropdownContext = createContext({} as ContextProps)

export const NDropdown = forwardRef<HTMLDivElement | HTMLLIElement, NDropdownProps>(
    (
        {
            children,
            alignment,
        ...
        return popper ? (
            <NDropdownContext.Provider value={contextValues}>
                <Manager>{dropdownContent()}</Manager>
            </NDropdownContext.Provider>
        ) : (
            <NDropdownContext.Provider value={contextValues}>
                {dropdownContent()}
            </NDropdownContext.Provider>
