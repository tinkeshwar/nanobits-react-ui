...
export interface NCollapseProps extends HTMLAttributes<HTMLDivElement> {
  /**
...
export const NCollapse = forwardRef<HTMLDivElement, NCollapseProps>(
...
NCollapse.displayName = 'NCollapse'
