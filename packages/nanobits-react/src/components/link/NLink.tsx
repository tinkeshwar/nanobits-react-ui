...
export interface NLinkProps extends AllHTMLAttributes<HTMLElement> {
  /**
...
export const NLink = forwardRef<HTMLButtonElement | HTMLAnchorElement, NLinkProps>(
    ({ children, active, className, component: Component = 'a', disabled, ...rest }, ref) => {
        // TODO: remove duplicated classes ex. `active active` in `<NListGroupItem>`
