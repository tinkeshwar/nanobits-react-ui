...
import { NBackdrop } from '../backdrop/NBackdrop'
import { NModalContent } from './NModalContent'
import { NModalDialogue } from './NModalDialogue'

export interface NModalProps extends HTMLAttributes<HTMLDivElement> {
  /**
...
export const NModalContext = createContext({} as ModalContextProps)

export const NModal = forwardRef<HTMLDivElement, NModalProps>(
    (
        {
            children,
            alignment,
        ...
        const modal = (ref?: React.Ref<HTMLDivElement>, transitionClass?: string) => {
            return (
                <NModalContext.Provider value={contextValues}>
                    <div
                    ...
                    >
                        <NModalDialogue
                            ...
                            size={size}
                        >
                            <NModalContent ref={modalContentRef}>{children}</NModalContent>
                        </NModalDialogue>
                    </div>
                </NModalContext.Provider>
            )
        }
        ...
        return (
            <>
                ...
                {typeof window !== 'undefined' && portal
                    ? backdrop && createPortal(<NBackdrop visible={_visible} />, document.body)
                    : backdrop && <NBackdrop visible={_visible} />}
            </>
        )
    },
)
